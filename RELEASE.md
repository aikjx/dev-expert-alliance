# 开发专家联盟 (Dev Expert Alliance) v1.1.0

一个跨开发领域的 **WorkBuddy Team 型专家联盟**，由 1 个编排中枢（Team Lead）+ 6 个领域专家组成，覆盖信息化项目开发的全生命周期：**架构 → 后端 → 前端 → 数据 → 测试 → 安全**。

## ✨ 核心特性

- **六位一体专家团队**：架构蓝图师、后端引擎师、前端画布师、数据管家、质量守门人、安全哨兵。
- **五大协同工作流**：
